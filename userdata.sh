...
read -p "Enter your database name :" dbname
	...
	read -s "Enter your database password :" passwd
...
# openssl passwd -1
# PASS="password"
#read -p "Please enter password for your msyql-admin :" openssl passwd -1 adminpasswd
echo "Please enter the password for root database user"
read -s adminpasswd
mysqladmin password $adminpasswd
	...
	read -p "Enter a database name " newdbname
 	...
 	read -s "Enter password for the user $wpuser " wpuserpasswd
